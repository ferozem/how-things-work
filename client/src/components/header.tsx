...
export default function Header() {
  ...
  const navItems = [
    { href: "/", label: "Home", icon: "fa-solid fa-home" },
    { href: "/videos", label: "Videos", icon: "fa-solid fa-video" },
          ...
          <Link href="/">
            <div className="flex items-center space-x-3 cursor-pointer">
              <div className="w-12 h-12 bg-[hsl(var(--discovery-blue))] rounded-full flex items-center justify-center animate-bounce-slow overflow-hidden">
                ...
                />
                <i className="fa-solid fa-lightbulb text-white text-xl hidden"></i>
              </div>
              <div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/parent-zone">
              <Button className="bg-[hsl(var(--bright-yellow))] text-[hsl(var(--dark-slate))] hover:bg-yellow-400 transition-colors font-bold">
                <i className="fa-solid fa-chalkboard-teacher mr-2"></i>Parents & Teachers
              </Button>
            </Link>
          </div>
                ...
                <div className="flex flex-col space-y-6 mt-8">
                  ...
                  <Link href="/parent-zone">
                    <div 
                      ...
                      onClick={() => setIsOpen(false)}
                    >
                      <i className="fa-solid fa-chalkboard-teacher text-lg"></i>
